...
.constant("Nucleus",require("electron-nucleus")("5aa7b598bcaaac001bc09172", {
	...
	version: '10000' // Set a custom version
}))
.constant("AIV_CONSTANTS",{
	"BASE_URL" : 'http://35.197.240.3/capturltd.co.uk/capturcsidemo.com/woocommerce/mobileAPI',
	"LOYALTY_URL" : 'http://35.197.240.3/capturltd.co.uk/capturcsidemo.com/woocommerce/mobileAPI/anlyticsapi/_hfloyalty',
	"CORS_URL": 'http://capturltd.co.uk/cors.php',
	"REMOTE_DB": 'pos_capturcsidemo',
	"CUSER":"captur",
	"CPASS":"CapturLtd1986",
	"AUSER":"aivknowtech",
	"APASS":"aivknowtech6",
	"REMOTE_DBURL": "http://captur:CapturLtd1986@35.197.240.3:5984/pos_capturcsidemo",
	"SECOND_DB": 'pos_capturcsidemo',
	"SECOND_DBURL": "http://192.168.1.131:5984/pos_capturcsidemo",
	"POSTCODE_API_URL":'https://api.ideal-postcodes.co.uk/v1/postcodes/',
	"LS_PREFIX" : 'aivrpos_capturcsidemo_',
	"SYNC_TIMEOUT":5000,
	"OPTION_SEPARATOR":'###',
	"TEST_MODE":false,
	"TEST_KITCHEN":false,
...
/* .constant("AIV_CONSTANTS",{
	"BASE_URL" : 'http://35.197.240.3/capturltd.co.uk/capturtableposdemo.co.uk/woocommerce/mobileAPI',
    "LOYALTY_URL" : 'http://35.197.240.3/capturltd.co.uk/CapturAdmin/_hfloyalty',
	"CORS_URL": 'http://35.197.240.3/capturltd.co.uk/capturtableposdemo.co.uk/woocommerce/mobileAPI/API.php',
...
.config(function($stateProvider, $urlRouterProvider,$ionicConfigProvider,AIV_CONSTANTS,ionicTimePickerProvider) {
    ...
    .state('tab', {
        url: "/tab",
        abstract: true,
        templateUrl: 'templates/front_copy.html',
        controller: 'MultiWindow'
    })
